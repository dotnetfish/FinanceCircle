...
import com.superstudio.app.bean.Active.ObjectReply;
...
import com.superstudio.app.util.ImageUtils;
...
public class ActiveAdapter extends ListBaseAdapter {
    private final static String AT_HOST_PRE = "http://my.fengdengjie.com";
    private final static String MAIN_HOST = "http://www.fengdengjie.com";
    ...
    private String modifyPath(String message) {
        ...
        message = message.replaceAll(
                "(<a[^>]+href=\")http://m.fengdengjie.com([\\S]+)\"", "$1"
                        + MAIN_HOST + "$2\"");
        return message;
    }
