...
import com.superstudio.app.adapter.MessageDetailAdapter;
...
import com.superstudio.app.bean.MessageDetail;
import com.superstudio.app.bean.MessageDetailList;
...
public class MessageDetailFragment extends BaseListFragment<MessageDetail> implements
    ...
    private void handleShowDate(List<MessageDetail> list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--) {
            msg = list.get(i);
            Date date = com.superstudio.app.util.StringUtils.toDate(msg.getPubDate());
    ...
    private void sendMessage(MessageDetail msg) {
        ...
        Date date = new Date();
        msg.setPubDate(com.superstudio.app.util.StringUtils.getDateString(date));
