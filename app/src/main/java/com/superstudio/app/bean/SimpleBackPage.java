package com.superstudio.app.bean;

import com.superstudio.app.R;
import com.superstudio.app.fragment.AboutOSCFragment;
import com.superstudio.app.fragment.ActiveFragment;
import com.superstudio.app.fragment.BrowserFragment;
import com.superstudio.app.fragment.CommentFrament;
import com.superstudio.app.fragment.EventAppliesFragment;
import com.superstudio.app.fragment.EventFragment;
import com.superstudio.app.fragment.FeedBackFragment;
import com.superstudio.app.fragment.MessageDetailFragment;
import com.superstudio.app.fragment.MyInformationFragment;
import com.superstudio.app.fragment.MyInformationFragmentDetail;
import com.superstudio.app.fragment.QuestionTagFragment;
import com.superstudio.app.fragment.SettingsFragment;
import com.superstudio.app.fragment.SettingsNotificationFragment;
import com.superstudio.app.fragment.SoftWareTweetsFrament;
import com.superstudio.app.fragment.TweetLikeUsersFragment;
import com.superstudio.app.fragment.TweetRecordFragment;
import com.superstudio.app.fragment.TweetsFragment;
import com.superstudio.app.fragment.UserCenterFragment;
import com.superstudio.app.improve.fragments.blog.UserBlogFragment;
import com.superstudio.app.improve.fragments.tweet.SoftWareForTweetsFragment;
import com.superstudio.app.team.fragment.NoteBookFragment;
import com.superstudio.app.team.fragment.NoteEditFragment;
import com.superstudio.app.team.fragment.TeamActiveFragment;
import com.superstudio.app.team.fragment.TeamDiaryDetailFragment;
import com.superstudio.app.team.fragment.TeamDiscussFragment;
import com.superstudio.app.team.fragment.TeamIssueFragment;
import com.superstudio.app.team.fragment.TeamMemberInformationFragment;
import com.superstudio.app.team.fragment.TeamProjectFragment;
import com.superstudio.app.team.fragment.TeamProjectMemberSelectFragment;
import com.superstudio.app.team.viewpagefragment.MyIssuePagerfragment;
import com.superstudio.app.team.viewpagefragment.TeamDiaryFragment;
import com.superstudio.app.team.viewpagefragment.TeamIssueViewPageFragment;
import com.superstudio.app.team.viewpagefragment.TeamProjectViewPagerFragment;
import com.superstudio.app.viewpagerfragment.BlogViewPagerFragment;
import com.superstudio.app.viewpagerfragment.EventViewPagerFragment;
import com.superstudio.app.viewpagerfragment.FriendsViewPagerFragment;
import com.superstudio.app.viewpagerfragment.NoticeViewPagerFragment;
import com.superstudio.app.viewpagerfragment.OpensourceSoftwareFragment;
import com.superstudio.app.viewpagerfragment.QuestViewPagerFragment;
import com.superstudio.app.viewpagerfragment.SearchViewPageFragment;
import com.superstudio.app.viewpagerfragment.UserFavoriteViewPagerFragment;
