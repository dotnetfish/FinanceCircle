...
public class ServerTaskService extends IntentService {
    ...
    public static final String ACTION_PUB_BLOG_COMMENT = "com.superstudio.app.ACTION_PUB_BLOG_COMMENT";
    public static final String ACTION_PUB_COMMENT = "com.superstudio.app.ACTION_PUB_COMMENT";
    public static final String ACTION_PUB_POST = "com.superstudio.app.ACTION_PUB_POST";
    public static final String ACTION_PUB_TWEET = "com.superstudio.app.ACTION_PUB_TWEET";
    public static final String ACTION_PUB_SOFTWARE_TWEET = "com.superstudio.app" +
