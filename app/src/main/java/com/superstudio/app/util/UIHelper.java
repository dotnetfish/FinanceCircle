package com.superstudio.app.util;
...
import com.superstudio.app.AppConfig;
...
import com.superstudio.app.bean.News;
import com.superstudio.app.bean.Notice;
import com.superstudio.app.bean.ShakeObject;
...
import com.superstudio.app.fragment.FriendsFragment;
...
import com.superstudio.app.improve.detail.activities.NewsDetailActivity;
import com.superstudio.app.improve.detail.activities.QuestionDetailActivity;
import com.superstudio.app.improve.detail.activities.SoftwareDetailActivity;
import com.superstudio.app.improve.detail.activities.TranslateDetailActivity;
...
import com.superstudio.app.interf.ICallbackResult;
import com.superstudio.app.interf.OnWebViewImageListener;
import com.superstudio.app.service.DownloadService;
import com.superstudio.app.service.DownloadService.DownloadBinder;
import com.superstudio.app.service.NoticeService;
import com.superstudio.app.team.adapter.TeamMemberAdapter;
...
import com.superstudio.app.team.ui.TeamNewIssueActivity;
import com.superstudio.app.ui.DetailActivity;
import com.superstudio.app.ui.LoginActivity;
import com.superstudio.app.ui.OSCPhotosActivity;
import com.superstudio.app.ui.SimpleBackActivity;
import com.superstudio.app.ui.TweetPubActivity;
...
//                    showTweetDetail(context, null, id);
    ...
    private static void showUrlRedirect(Context context, long id, String url) {
        ...
        if (url.contains("city.fengdengjie.com/")) {
            if (id == 0)
    ...
    public static void openBrowser(Context context, String url) {
        ...
        if (url.startsWith("http://www.fengdengjie.com/tweet-topic/")) {
            Bundle bundle = new Bundle();
