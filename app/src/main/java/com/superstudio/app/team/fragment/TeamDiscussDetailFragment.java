...
import com.superstudio.app.team.bean.TeamDiscussDetail;
...
public class TeamDiscussDetailFragment extends
    ...
    protected void executeOnLoadDetailSuccess(TeamDiscuss detailBean) {
        ...
        String author = String.format("<a class='author' href='http://my.fengdengjie.com/u/%s'>%s</a>", detailBean.getAuthor().getId(), detailBean.getAuthor().getName());
